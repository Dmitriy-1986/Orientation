const data = [
            ...
            { img: "./images/AP1257AB.webp", brand: "ЗАЗ 1103", number: "АР 1257 АВ" }, 
            { img: "./images/33303BH.webp", brand: "Екскаватор JCB 3CX", number: "33303 BH" }, 
            { img: "./images/no-image.webp", brand: "Citroen Jumper", number: "АА 9182 ТН" },
            { img: "./images/no-image.webp", brand: "Citroen Jumper", number: "АА 5097 ЕО" },
            { img: "./images/no-image.webp", brand: "Renault", number: "АА 1367 МА" },
            { img: "./images/no-image.webp", brand: "Renault", number: "АА 1379 МА" },
            { img: "./images/no-image.webp", brand: "Renault Logan", number: "АА 8341 КВ" },
            { img: "./images/no-image.webp", brand: "Fiat Doblo", number: "КА 8021 ВІ" },
            { img: "./images/no-image.webp", brand: "Fiat Doblo", number: "КА 8036 ВІ" },
            { img: "./images/no-image.webp", brand: "Fiat Doblo", number: "КА 8057 ВІ" }, 
            { img: "./images/no-image.webp", brand: "Citroen Jumper", number: "КА 7425 ВО" }, 
            { img: "./images/no-image.webp", brand: "Citroen Jumper", number: "КА 7427 ВО" }, 
            { img: "./images/no-image.webp", brand: "Citroen Berlingo", number: "КА 9932 СХ" },
            { img: "./images/no-image.webp", brand: "Citroen Berlingo", number: "КА 9937 СХ" },
            ...
            { img: "./images/no-image.webp", brand: "Renault Kangoo", number: "АЕ 8627 КР" },
            { img: "./images/no-image.webp", brand: "Камаз", number: "АР 1550 АС" },
            { img: "./images/no-image.webp", brand: "Причеп СОМЕР", number: "АР 1603 ХО" },
